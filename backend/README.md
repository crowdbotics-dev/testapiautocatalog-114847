...
## Project Structure
    ...
    ├── testapiautocatalog_114847  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_114847`
...
2. Clone this repo and `cd testapiautocatalog_114847`
